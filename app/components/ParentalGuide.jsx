...
export default function ParentalGuide() {
  return (
    <section className="relative max-w-7xl mx-auto px-4 py-8 ">
      ...
      <p className="my-8 md:pb-20 pb-10  text-center text-grey">
      ...
      <div className="space-y-12">
        {programData.map((program, index) => {
          ...
          return (
            <div
              key={index}
              className={`md:flex md:items-start md:space-x-16 md:justify-between ${reverseFlex}`}
            >
                ...
                <div className={`relative z-10 ${overlapMargin}`}>
                  <Image
                    ...
                    className="
                      ...
                      md:w-[476.87px]    /* Medium screens: specific width */
