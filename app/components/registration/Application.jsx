  ...
  const ConfirmationStep = () => (
    <form onSubmit={handleSubmit(onSubmit)} className="p-8">
      ...
      <div className="max-w-4xl text-[#555555]">
          ...
          <tbody>
            <tr>
              <td className="border border-[#555555] p-1">
                <div className="mb-4">Oxford Centre for Leadership Summer Program - July 8th - August 1st, 2025</div>
        ...
        <div className="mt-8">
          <p className="text-sm mb-4">Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our privacy policy.</p>
