    ...
    import { logEvent } from "../lib/analytics"; // Import the batched logging utility
    ...
    export default function EnrollmentForm() {
        ...
        // Log 'form_opened' event when the component loads
        useEffect(() => {
            logEvent("form_opened", { page: "/enrollment" });
        }, []);
        ...
        const handleChange = (e) => {
            ...
            // Log "filling_form" event only once when the user starts typing
            if (!formStarted) {
                setFormStarted(true);
                console.log('filling_form');
        ...
        const handleEnrollSubmit = async (e) => {
            ...
            try {
                // Create a new enrolled user in Sanity
                await client.create({
                    _type: "enrolledUser",
                    userId: uniqueUserId,
                    ...formData,
                ...
                logEvent("enrollment_submitted", {}, uniqueUserId);
